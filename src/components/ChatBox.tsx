    ...
    <div className="p-2 w-full">
      ...
      <div className='w-full flex items-center gap-2 px-2'>
        ...
        <svg 
          ...
          <path d="M9.52376 31.2179V25.2328C9.52376 24.5574 10.1808 24.0771 10.8244 24.2822L17.7097 26.476C18.5445 26.742 18.6556 27.878 17.888 28.3006L11.0027 32.0918C10.3378 32.458 9.52376 31.9769 9.52376 31.2179Z" stroke="black" stroke-width="2"/>
          <path d="M11.3852 21.3187C11.0281 21.6874 10.4907 21.8177 10.0043 21.6536L2.6643 19.1766C0.588648 18.4441 0.410211 15.578 2.37897 14.5936L29.0279 1.26912C30.8964 0.334858 33.0169 1.97405 32.5834 4.01765L28.148 24.9275C27.839 26.3838 26.3315 27.247 24.9192 26.7762L14.7175 23.368C14.0313 23.1388 13.8096 22.2783 14.2996 21.746L22.5388 12.7948C23.0833 12.1729 23.485 11.5192 22.8631 10.9748C22.2412 10.4303 21.4275 10.8907 20.883 11.5126L11.3852 21.3187Z" stroke="black" stroke-width="2"/>
        </svg>
      </div>
    </div>
  );
