    ...
    >
      ...
      >
        ...
        <div className='absolute w-full flex justify-end bottom-0 right-0 p-5'>
          <Link href="/help">
            <svg className='w-[18px] lg:w-[25px]' width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div>
        <p className=' text-sm lg:text-lg text-roboto'>Designed and Developed by Jonathan Talbot</p>
      </div>
    </div>
  );
}
